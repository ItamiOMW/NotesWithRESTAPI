...
fun EditNoteScreen(
    ...
    LaunchedEffect(key1 = Unit) {
        uiEvent.collect { event ->
            when (event) {
                is EditNoteUiEvent.OnNoteSaved -> onSavedSuccessfully()

                is EditNoteUiEvent.OnShowSnackbar -> {
                ...
                EditNoteUiEvent.OnNoteDeleted -> onDeletedSuccessfully()
            }
        }
    }
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    if (state.getNoteErrorMessage == null) {
                        IconButton(
                            onClick = {
                                onEvent(EditNoteEvent.OnDeleteClick)
                            }
                        ) {
                            Icon(
            ...
            if (state.getNoteErrorMessage == null) {
                ...
                Row(
                    ...
                    ButtonComponent(
                        ...
                        onButtonClick = { onEvent(EditNoteEvent.OnSaveClick) },
        ...
        if (state.getNoteErrorMessage == null) {
            Box(
                ...
                Column(
                    ...
                    TitleInputTextField(
                        ...
                        onValueChange = { onEvent(EditNoteEvent.OnTitleInputValueChange(it)) },
                    ...
                    ContentInputTextField(
                        ...
                        isLoading = { state.isLoading },
                        onValueChange = { onEvent(EditNoteEvent.OnContentInputValueChange(it)) }
                    )
                }
            ...
            Box(
                ...
                LoadingFailedComponent(
                    errorMessage = state.getNoteErrorMessage,
                    onRetryClick = null,
